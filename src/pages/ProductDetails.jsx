...
const SingleProductPage = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`https://e-commerce-backend-a9ec.onrender.com/products/${productID}`);
    ...
    <Wrapper className='container section-center page'>
      ...
      <div className='product-center row'>
        ...
        <div className='col-md-6 content'>
          <h1>{title}</h1>
          <h5 className='price me-2 d-inline'>Rs.{price} </h5>
          {old_price && <h6 className='old-price d-inline'>Rs.{old_price} </h6>}
